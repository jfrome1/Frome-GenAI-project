...
GenAI poses unprecedented challenges and opportunities for courses with writing-based assessments. Unfortunately, instructors are currently making course policies with little to no evidence about how their students actually use GenAI. This research project aims to provide a window onto that use to help instructors make informed decisions. We are inviting instructors to allow student use of GenAI on the condition that they submit links to their chats for analysis.

Student GenAI use is nearly impossible to prevent, and suspected violations of bans are nearly impossible to penalize. Our view is that it is better to know how students are using GenAI so instructors can develop course policies that match their course learning objectives.
